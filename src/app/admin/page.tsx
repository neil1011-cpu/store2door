...
export default function DashboardPage() {
    ...
    const dashboardItems = useMemo(() => {
        ...
        return [
            ...
            { title: 'Total Revenue', value: `$${totalRevenue.toLocaleString()}`, icon: <TrendingUp size={100} />, color: 'bg-emerald-500', href: '/admin/finance' },
            { title: 'Net Profit', value: `$${netProfit.toLocaleString()}`, icon: <DollarSign size={100} />, color: 'bg-cyan-500', href: '/admin/finance' },
